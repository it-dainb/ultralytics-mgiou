...
class ClassificationDataset:
    ...
    def __init__(self, root: str, args, augment: bool = False, prefix: str = "", grayscale: bool = False):
        ...
        # Use single-channel mean/std for grayscale to be consistent with RGB normalization
        # RGB DEFAULT_MEAN=(0.0, 0.0, 0.0), DEFAULT_STD=(1.0, 1.0, 1.0) produces range [0, 1]
        # Grayscale uses (0.0,), (1.0,) to produce the same [0, 1] range
        transform_mean = (0.0,) if grayscale else DEFAULT_MEAN
        transform_std = (1.0,) if grayscale else DEFAULT_STD
